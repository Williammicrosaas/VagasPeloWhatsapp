...
function ProfilePage() {
            ...
            const fetchUserData = {
                "ProfilePage.useEffect.fetchUserData": async ()=>{
                    try {
                        ...
                        if (userError) {
                            console.error("[v0] Erro ao buscar dados do usuário:", userError);
                        // Não redirecionar, apenas continuar com dados vazios
                        }
                        if (userData) {
                            setFormData({
    ...
    const handleSaveProfile = async (e)=>{
        ...
        try {
            ...
            console.log("[v0] Salvando perfil:", {
                user_id: user.id,
                ...formData
            });
            ...
            if (updateError) {
                console.error("[v0] Erro ao atualizar perfil:", updateError.message);
    ...
    const handleSavePreferences = async (e)=>{
        ...
        if (!preferences.job_area || !preferences.country) {
            setError("Preencha todos os campos de preferência");
            setSaving(false);
            return;
        }
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
        try {
            ...
            console.log("[v0] Salvando preferências:", {
                user_id: user.id,
                ...preferences
            });
            // Usar upsert para evitar erro de constraint única
            const { error: prefError, data: prefData } = await supabase.from("job_preferences").upsert({
                user_id: user.id,
                job_area: preferences.job_area.trim(),
            ...
            if (prefError) {
                console.error("[v0] Erro ao salvar preferências:", {
                    message: prefError.message,
                    details: prefError.details,
                    hint: prefError.hint,
                    code: prefError.code
                });
                throw new Error(prefError.message || "Erro ao salvar preferências");
            }
            // Verificar se foi criado novo ou atualizado existente
            const isNew = prefData && new Date(prefData.created_at).getTime() > Date.now() - 1000;
            setSuccessMessage(isNew ? "Preferência adicionada com sucesso!" : "Preferência atualizada com sucesso!");
            setPreferences({
                job_area: "",
                country: ""
            });
            ...
            console.error("[v0] Erro capturado:", err);
            const errorMsg = err instanceof Error ? err.message : "Erro ao salvar preferências";
            setError(errorMsg);
        } finally{
            setSaving(false);
        }
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Configure suas informações e preferências de emprego"
                            }, void 0, false, {
                                fileName: "[project]/app/dashboard/profile/page.tsx",
                                lineNumber: 248,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        ...
                                        children: "Atualize seus dados de contato"
                                    }, void 0, false, {
                                        fileName: "[project]/app/dashboard/profile/page.tsx",
                                        lineNumber: 255,
                                        columnNumber: 15
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                    ...
                                    children: [
                                        ...
                                        successMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex gap-2 rounded-lg bg-emerald-500/10 p-3 text-sm text-emerald-400",
                                            children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                        className: "text-xl text-white",
                                        children: "Preferências de Emprego"
                                    }, void 0, false, {
                                        fileName: "[project]/app/dashboard/profile/page.tsx",
                                        lineNumber: 347,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        className: "text-slate-400",
                                        children: "Defina as áreas e países onde deseja receber oportunidades"
                                    }, void 0, false, {
                                        fileName: "[project]/app/dashboard/profile/page.tsx",
                                        lineNumber: 348,
                                        columnNumber: 15
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                    ...
                                    children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                                            htmlFor: "jobArea",
                                                            className: "text-slate-200",
                                                            children: "Área de Trabalho ou Cargo"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/dashboard/profile/page.tsx",
                                                            lineNumber: 356,
                                                            columnNumber: 21
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                            ...
                                                            onChange: (e)=>handlePreferenceChange("job_area", e.target.value),
                                                            className: "border-slate-600 bg-slate-800 text-white placeholder-slate-500"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/dashboard/profile/page.tsx",
                                                            lineNumber: 359,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            disabled: saving,
                                            className: "bg-gradient-to-r from-blue-500 to-emerald-500 text-white hover:from-blue-600 hover:to-emerald-600",
                                            children: saving ? "Adicionando..." : "Adicionar Preferência"
                                        }, void 0, false, {
                                            fileName: "[project]/app/dashboard/profile/page.tsx",
                                            lineNumber: 403,
                                            columnNumber: 17
...
_s(ProfilePage, "VvKNxIxbzFYBbzI+8DgqUhMS6LI=", false, function() {
    return [
...
//# sourceMappingURL=_e5c5dc32._.js.map